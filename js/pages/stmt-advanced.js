...
function printRunningBal() {
  ...
  const PCSS_STMT = `*{font-family:Tahoma,sans-serif;direction:rtl;margin:0;padding:0;box-sizing:border-box}
  ...
  w.document.write(`<!DOCTYPE html><html dir="rtl"><head><meta charset="UTF-8"><title>كشف حساب<\/title><style>${PCSS_STMT}<\/style><\/head><body>
    <div class="hdr">
...
function printNote(id) {
  ...
  const PCSS_STMT = `*{font-family:Tahoma,sans-serif;direction:rtl;margin:0;padding:0}body{padding:15px;font-size:11px}
  ...
  w.document.write(`<!DOCTYPE html><html dir="rtl"><head><meta charset="UTF-8"><title>${n.number}<\/title><style>${PCSS_STMT}<\/style><\/head><body>
    <div class="hdr">
