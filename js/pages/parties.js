...
function _pw(title,html){const w=window.open('','_blank');const sc='<scr'+'ipt>setTimeout(()=>window.print(),600)<'+'/scr'+'ipt>';w.document.write('<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>'+title+'<\/title><style>'+PCSS+'<\/style><\/head><body>'+html+sc+'<\/body><\/html>');w.document.close();}
